...
temp_train_path = r"C:\Users\wolfe\Desktop\ISEC\3_Ano\1_Semestre\IC\TP\DataSet\Skin_Diseases\kaggle\temp_train"
train_path = r"C:\Users\wolfe\Desktop\ISEC\3_Ano\1_Semestre\IC\TP\DataSet\Skin_Diseases\kaggle\train"  # Caminho de treino
test_path = r"C:\Users\wolfe\Desktop\ISEC\3_Ano\1_Semestre\IC\TP\DataSet\Skin_Diseases\kaggle\test"  # Caminho de teste
val_path = r"C:\Users\wolfe\Desktop\ISEC\3_Ano\1_Semestre\IC\TP\DataSet\Skin_Diseases\kaggle\val"  # Caminho de validação
img_size = 128 # Tamanho das imagens
batch_size = 16  # Tamanho do lote para treinamento


trainWSA_datagen = ImageDataGenerator(
    rescale=1. / 255,
    fill_mode='nearest'
)
...
history = model.fit(
    trainWSA_generator,
    epochs=1,  # Número de épocas (pode ser aumentado para melhor convergência)
